...
export const stateDir = path.join(claudeDir, 'coub-panel');
export const stateFileName = 'state';
export const stateFile = path.join(stateDir, stateFileName);
export const hookScript = path.join(stateDir, 'coub-hook.sh');
...
# Managed by the Coub Panel VS Code extension.
dir="$(dirname "$0")"
